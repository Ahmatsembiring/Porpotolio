      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white p-6 rounded-2xl shadow-sm border">
            <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-6 h-6 text-red-600" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.615 3.184c-3.604-.276-11.596-.276-15.2 0-3.603.276-3.603 4.598-3.603 4.598 0 3.347 2.423 6.385 2.423 6.385s-2.423 3.038-2.423 6.385c0 0 0 4.322 3.603 4.598 3.604.276 11.596.276 15.2 0 3.603-.276 3.603-4.598 3.603-4.598 0-3.347-2.423-6.385-2.423-6.385s2.423-3.038 2.423-6.385c0 0 0-4.322-3.603-4.598zm-10.4 14.598v-9.2l8.4 4.6z" />
              </svg>
            </div>
            ...
            <a
              href="https://youtube.com/@NAMA_ASLI_KAMU"
              target="_blank"
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border">
            ...
            <a
              href="https://instagram.com/NAMA_ASLI_KAMU"
              target="_blank"
              rel="noopener noreferrer"
